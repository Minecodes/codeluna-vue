    ...
    return {
      ...
      btns: [
        ...
        },
        {
          name: 'Projects',
          title: 'PROJECTS',
          window_title: 'luna Dev | PROJECTS',
          route: '/projects',
          active: false,
        },
        {
        ...
        },
        {
          name: 'Guild',
          title: 'DEV GUILD',
          window_title: 'luna Dev | DEV GUILD',
          route: '/guild',
          active: false,
        },
        {
          ...
          window_title: 'luna Dev | CONTACT & IMPRINT',
          route: '/contact',
          active: false,
        },
      ],
